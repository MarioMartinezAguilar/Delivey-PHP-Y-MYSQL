...
<div class="container" style="margin-top:30px">
  ...
  <h5> << DESGLOSE DE DIRECCIONES >></h5>
    <div class="col-sm-12">
        ...
        $id = $_GET['no'];
        $sentencia = "SELECT direccion.iddireccion AS direccion_id, direccion.nombre AS direccion_nombre,
          cliente.nombre AS cliente_nombre FROM direccion
          ...
          while ($valor = mysqli_fetch_assoc($consulta)){
            echo "<tr>";
                  echo "<td>"; echo $valor['direccion_id']; echo "</td>";
                  echo "<td>"; echo $valor['direccion_nombre']; echo "</td>";
