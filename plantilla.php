...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	<div class="btn-group btn-group-lg align-items-center col-12">
	  <button type="button" class="btn btn-info">PRINCIPAL</button>
	  <button type="button" class="btn btn-warning">CLIENTES</button>
	  <button type="button" class="btn btn-success">PEDIDOS</button>
	  <button type="button" class="btn btn-primary">MENUS</button>
