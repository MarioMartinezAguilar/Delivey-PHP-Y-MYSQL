  ...
  <h5> << DESGLOSE DE PEDIDOS >></h5>
    <div class="col-sm-12">
		...
		<?php
          ...
          $id = $_GET['no'];
          $sentencia = " SELECT pedido.fecha AS pedido_fecha, pedido.idpedido AS pedido_id,
          menu.nombre AS menu_nombre, menu.precio AS menu_precio
          FROM orden  INNER JOIN pedido ON idpedido = pedido_idpedido
          INNER JOIN menu ON idmenu = menu_idmenu WHERE idpedido = '".$id."' ";
          ...
          while($valor = mysqli_fetch_assoc($consulta)){
            echo "<tr>";
                  ...
                  echo "<td>"; echo $valor['menu_nombre']; echo "</td>";
                  echo "<td>"; echo $valor['menu_precio']; echo "</td>";
            echo "</tr>";
          }
		?>
    </div>
